...
const postScheme = new Schema({
  title: { type: String, required: [true, "title is required"], minLength: [3, "title length must be at least 5 characters"], maxLength: [100, "title length cannot exceed more than 100 characters"] },
